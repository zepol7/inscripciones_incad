...
$.extend($.validator, {
	...
	prototype: {
		...
		showLabel: function( element, message ) {
		   ...
		   //$('#contenedor_error').append('<b>' + element.name+':</b>&nbsp;&nbsp;'+ message +'<br />');
		   $('#contenedor_error').html('<p style="margin: 5px 5px 5px 5px;">Los campos marcados en rojo son obligatorios</p>');
		   
		   //alert($("#titulo").innerHTML);
		   
		   if(message!='obligatorio'){
