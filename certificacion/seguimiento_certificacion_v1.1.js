...
function cambiar_estado_graduar(id_academica){
    
    
    var val_id_academica = $("#id_estado_grado_"+id_academica).prop('checked');
    //var val_resultado = 0;
    if(val_id_academica == true){
        var val_resultado = 1;
    }
    ...
    var params = 'opcion=2&id_academica=' + id_academica + '&val_resultado=' + val_resultado + '&id_tipo=8';
    llamarAjax("seguimiento_certificacion_ajax.php", params, "div_cambio_estado_grado_"+id_academica, "");
