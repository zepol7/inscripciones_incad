...
function descargar_base_empresas(){
    setTimeout(function(){ 
...
function ver_todas_empresas() {
    ...
    llamarAjax("empresas_ajax.php", params, "principal_empresas", "mostrar_formulario(1)");
}
...
function validar_nit_existente(documento, tipo, id_empresa) {
    ...
    if (tipo == 1) {
        ...
        llamarAjax("empresas_ajax.php", params, "div_nit_existe", "");
    } else if (tipo == 2) {
        var params = 'opcion=5&nit_empresa=' + documento + '&tipo=' + tipo + '&id_empresa=' + id_empresa;
...
function modalConfirmarGuardar(titulo, funcion) {
    ...
    llamarAjax("empresas_ajax.php", params, "ventanaModal", "mostrarModalConfirmacion();");
}
...
function confirmarEdicion(titulo, funcion) {
    ...
    llamarAjax("empresas_ajax.php", params, "ventanaModal", "mostrarVentana();");
}
...
function crear_empresa() {
    ...
    llamarAjax("empresas_ajax.php", params, "principal_empresas", "validar_exito();volver_inicio();");
...
function editar_empresa() {
    ...
    llamarAjax("empresas_ajax.php", params, "principal_empresas", "validar_exito();volver_inicio()");
    //llamarAjax("empresas_ajax.php", params, "principal_empresas", "");
