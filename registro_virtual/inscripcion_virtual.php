...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type='text/javascript' >
            function cargar_registro_id(id_registro){
                var params = 'opcion=1&id_registro=' + id_registro;
                llamarAjax("inscripcion_virtual_ajax.php", params, "principal_registro", "calcular_edad()");
            }
        </script>
    ...
    <body>
        ...
        $contenido->cabecera_registro_virtual_html();
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li>Inscripci&oacute;n virtual de Estudiantes </li>
                    </ol>
                </div>
            </div>
            ...
            <?php
            if(isset($_SESSION["DocumentoPersona"])){
                ?>   
                <script id='ajax'>
                    cargar_registro_id(<?php echo($_SESSION["IdPersona"]);?>);
                </script>
                <?php    
            }
            ?>   
            ...
            <div class="row">
            	...
            	<div class="col-md-12">
            		<div id="principal_registro"></div>
                        ...
                        <div id="d_envio_email" style="display: none;"></div>
        ...
        <script type='text/javascript' src='inscripcion_virtual_v1.js'></script>
