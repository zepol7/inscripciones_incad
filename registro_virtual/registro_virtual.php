...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li>Inscripci&oacute;n Virtual para Estudiantes</li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">                            
                            <div class="form-group">
                                ...
                                <div class="col-md-4">                   
                                    <input type="text" class="form-control" id="txt_busca_id" name="txt_busca_id" placeholder="Documento" onblur="trim_cadena(this);" >   
                                </div>
                                <div class="col-md-4">
        ...
        <script type='text/javascript' src='registro_virtual.js'></script>
