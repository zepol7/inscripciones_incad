...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="mostrar_form_lista();">
        <?php
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 fondoAzul">
                    <ol class="breadcrumb">
                        <li>Administrar Formatos de Cartas</li>
                    </ol>
                </div>
            </div>
        ...
        <script type='text/javascript' src='formatos_admin_v1.1.js'></script>
