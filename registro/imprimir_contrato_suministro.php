...
//Datos fortamos
$tabla_formatos = $dbformatos->getFomato(2);
...
<page>
    ...
    <table border='0' style="margin-left:30px;">        
        <tr>            
            <td width="30">&nbsp;</td>
            <td width="640">
            <p class="parrafo_text_1" style="text-align:center;"><b>CONTRATO ORDEN DE SUMINISTRO DE SERVICIO EDUCATIVO PROGRAMAS TÉCNICOS LABORALES</b></p>    
            </td>
        </tr>               
    </table>
	<br />    
    <table border='0' style="margin-left:30px;">        
        <tr>            
            <td width="30">&nbsp;</td>
            <td width="640">
            <p class="parrafo_text_1">Entre los suscritos la Entidad Educativa <b>INSTITUTO DE CIENCIAS ADMINISTRATIVAS S.A.S</b> con <b>NIT 900.567.627-6</b> y en su nombre <b>OLGA LUCIA FORERO MEJIA</b> identificada con cédula de ciudadanía <b>63.365.475 de Bucaramanga</b>  quien obrará como representante legal de dicha Institución Educativa, y la persona natural estudiante abajo firmante y cuyos datos se registran en la presente orden de suministro de servicio Educativo, se ha convenido celebrar el siguiente <b>CONTRATO ORDEN DE SUMINISTRO DE SERVICIO EDUCATIVO</b>, el  cual  se  regirá  por  las  normas  del  contrato  de  suministro  regulado  por  el título III del Código de Comercio así como las demás normas concordantes y en especial por las siguientes clausulas. <b>OBLIGACIONES DE INCAD.</b> <b>1.</b> Cumplir con la intensidad horaria requerida para cada programa. <b>2.</b> Programar capacitaciones, salidas extra clase a campo donde fuese necesario, y cualquier tipo de actividades extra curriculares que beneficien el proceso de aprendizaje. <b>PARÁGRAFO</b>. Las salidas de práctica visual o de campo en los programas requeridos serán sufragadas por los estudiantes, Las prácticas académicas reglamentarias de cada programa serán gestionadas por la institución sin ningún compromiso contractual con los estudiantes ni la empresa que otorgó dichas visitas o prácticas, pudiendo INCAD cambiar o suspender al estudiante que incumpla con dicha práctica; en todos los casos de práctica el estudiante deberá portar el respectivo uniforme 3. Colocar al servicio de los estudiantes en el proceso de aprendizaje, docentes seminaristas y tutores idóneos de acuerdo a criterios del INCAD. 4. Entregar recibo de constancia de cualquier pago hecho por el estudiante entendiéndose este como documento legal necesario en caso de cualquier reclamación. <b>5.</b> Informar a los estudiantes previamente de cualquier actividad programada mediante el cronograma de actividades de cada semestre educativo y en caso de ser una actividad extra se informará de manera directa, en cartelera y dado el caso por algún medio de comunicación masiva. 6. Suspender al estudiante que no cumpla con  la financiación acordada del pago de matrícula hasta tanto dicho pago sea realizado, sin que la institución se haga responsable por los temas académicos dejados de ver por el estudiante en mora, debiendo presentar dicho estudiante en mora trabajos y ser evaluados por los docentes respectivos por no ser presentados a tiempo por dicho motivo, teniendo la discrecionalidad el docente respectivo previa autorización administrativa de la persona encargada para tal fin por INCAD. 7. Aplicar sanciones respectivas cuando se requieran según Reglamento estudiantil. <b>8.</b> No se hará devoluciones de dinero en ningún caso a pesar de no continuar sus estudios con la Institución PARÁGRAFO: El estudiante podrá aplazar, ceder o vender su cupo y las obligaciones económicas contraídas con el Instituto INCAD S.A.S, por el estudiante serán de obligatorio cumplimiento. <b>9.</b> Dar cumplimiento al Reglamento Estudiantil que se encuentra publicado en los diferentes medios de comunicación usados por el Instituto. <b>OBLIGACIONES DE LOS ALUMNOS.</b> <b>1.</b> Cancelar oportunamente el valor del programa: <b><?php echo($programa_incad); ?></b>,  <b><?php echo($valor_neto_pagar_letras); ?></b> , <b>$<?php echo($valor_neto_pagar); ?></b> ; en caso de haber sido aprobada la financiación por parte de Instituto Incad S.A.S, se obliga a cancelar las cuotas en las fechas pactadas. <b>2.</b>  Portar el uniforme en los horarios de clase respectivos y abstenerse de hacerlo en eventos que no tengan nada que ver con la formación académica. <b>3.</b> Cumplir con los horarios respectivos de las horas de clase, eventos y actividades programadas <b>4.</b> Cumplir con todas las normas disciplinarias y en concordancia con la convivencia y respeto con todos los estamentos que conforman el instituto INCAD (estudiantes, Docentes, Administrativos y Directivos) <b>5.</b>  Solicitar Paz y Salvo en Tesorería, Documentación, y Académicamente con antelación y previo a la Certificación respectiva, máximo con quince días de anticipación a la entrega a la clausura el programa. <b>6.</b> Cumplir con todo lo estipulado en el Reglamento Estudiantil. </p>    
            </td>
        </tr>               
    </table>
    <br />    <br />    
