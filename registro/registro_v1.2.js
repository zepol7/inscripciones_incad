...
function calcular_pago_neto(){
    ...
    if (valor_neto < 0){
        ...
        //$('#valor_neto_pagar').val(formatNumber.new(valor_neto));
        valor_neto = formatearNumero(valor_neto)
...
function imprimir_pdf(div_imprimir){
        
       // div_imprimir = 'Capullo';
       var auxiliar = $('#principal_imprimir').html();
       var contenido = escape("<table border='1'>"+auxiliar+"</table>");
       //var contenido = "<table border='1'>"+auxiliar+"</table>";
       //
       //
       //var contenido = 'dsfsdfdsfdsf msfsdfisddskfldsñfldfdñls';
       
       
       $('#contenido').val(contenido);
       
       //alert(contenido);
        //window.open ("pdf.php?contenido="+contenido, '_blank');
        
        document.form_imprimir.submit()
