...
switch ($opcion) {
    case "1": //Crear Registro
        ...
        if (isset($_POST['id_registro'])) {
			...
			$tabla_registro = $dbRegistroPersonas->getRegistroPersona($_POST['id_registro']);
                        ...
                        $tipo_inscripcion = $tabla_registro['tipo_inscripcion'];
                        ...
                        $programa_tecnico = $tabla_registro['programa_tecnico'];
                        $practica_laboral = $tabla_registro['practica_laboral'];
                        
                        $unidad_negocio = $tabla_registro['unidad_negocio'];
                        $calendario_academico = $tabla_registro['calendario_academico'];
                        $jornada = $tabla_registro['jornada'];
                        $id_promotor = $tabla_registro['id_promotor'];
                        $periodicidad_pago = $tabla_registro['periodicidad_pago'];
                        
                        $estado_matriculado = $tabla_registro['estado_matriculado'];
                        
                        $id_ultimo_estudio = $tabla_registro['id_ultimo_estudio'];
                        $id_forma_pago = $tabla_registro['id_forma_pago'];
                        $id_entidad_financiera = $tabla_registro['id_entidad_financiera'];
        ...
        if (isset($_POST['id_registro_persona'])) {
                        $tipo_accion = 3; //Nueva inscripcion con persona creada
                 
			//Busca por el registro medico de la seleccionada
			$tabla_registro = $dbRegistroPersonas->getPersonaID($_POST['id_registro_persona']);
    ...
    ?>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><b>INFORMACI&Oacute;N ACAD&Eacute;MICA</b></div>
            <div class="panel-body">
                
                 <div class="row">
                    <div class="col-md-3 form-group">
                        <label for="">Tipo de Inscripci&oacute;n *</label>
                        <?php
                        $combo->getComboDb('tipo_inscripcion', $tipo_inscripcion, $dbListas->getListaDetalles(5), 'id_detalle, nombre_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                    </div>
                     
                     <div class="col-md-3 form-group">
                        <label for="">Fecha de Inscripci&oacute;n  *</label>
                        <input type="text" class="form-control" name="fecha_inscripcion" id="fecha_inscripcion" placeholder="dd/mm/aaaa" value="<?php echo $fecha_inscripcion;?>" onkeyup="DateFormat(this, this.value, event, false, '3');" onfocus="vDateType = '3';" onBlur="DateFormat(this, this.value, event, true, '3');">
                    </div>                   
                     
                    <div class="col-md-3 form-group">
                        <label for="">&Uacute;ltimo Estudio Aprobado *</label>
                        <!--<input type="text" class="form-control" name="ultimo_estudio" id="ultimo_estudio" placeholder="Ultimo Estudio" value="<?php echo $ultimo_estudio; ?>" onblur="trim_cadena(this); convertirAMayusculas(this);">-->
                        <?php
                        $combo->getComboDb('id_ultimo_estudio', $id_ultimo_estudio, $dbListas->getListaDetallesEditabel(6), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                        <div id='div_persona_buscar'></div>	
                    </div>
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <input type="text" class="form-control" name="institucion_estudio" id="institucion_estudio" placeholder="Institucion Estudio" value="<?php echo $institucion_estudio; ?>" onblur="trim_cadena(this); convertirAMayusculas(this);">
                    </div>                  
                </div>  
                 ...
                 <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <!--<input type="text" class="form-control" name="programa_incad" id="programa_incad" placeholder="Programa" value="<?php echo $programa_incad; ?>" onblur="trim_cadena(this); convertirAMayusculas(this);">-->
                        <?php
                        $combo->getComboDb('id_programa', $id_programa, $dbListas->getListaDetallesEditabel(4), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                        <input type="hidden" class="form-control" name="programa_incad" id="programa_incad" value="NULL" onblur="trim_cadena(this); convertirAMayusculas(this);">
                    </div>
                    <div class="col-md-3 form-group">
                        <label for="">Jornada *</label>
                        <?php
                        $combo->getComboDb('jornada', $jornada, $dbListas->getListaDetallesEditabel(3), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                        <input type="hidden" class="form-control" name="jornada_incad" id="jornada_incad" placeholder="Jornada" value="NULL" onblur="trim_cadena(this); convertirAMayusculas(this);">
                    </div>
                     
                     <div class="col-md-3 form-group">
                        <label for="">Calendario Acad&eacute;mico *</label>                        
                        <?php
                        $combo->getComboDb('calendario_academico', $calendario_academico, $dbListas->getListaDetallesEditabel(2), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                    </div>
                </div>
                ...
                <div class="row">
                     ...
                     <div class="col-md-3 form-group">
                        ...
                        <?php
                        $combo->getComboDb('unidad_negocio', $unidad_negocio, $dbListas->getListaDetallesEditabel(1), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                    </div>
                    
                    <div class="col-md-4 form-group">
                        <label for="">Ha estudiado antes un programa t&eacute;cnico:  *</label>
                        <?php
                        $combo->getComboDb('programa_tecnico', $programa_tecnico, $dbListas->getListaDetalles(11), 'id_detalle, nombre_detalle', '--Seleccione--', '', '', 'width:200px;', '', 'form-control');
                        ?>
                    </div>
                    <div class="col-md-5 form-group">
                        <label for="">Realiz&oacute; practica laboral con contrato de aprendizaje:  *</label>
                        <?php
                        $combo->getComboDb('practica_laboral', $practica_laboral, $dbListas->getListaDetalles(11), 'id_detalle, nombre_detalle', '--Seleccione--', '', '', 'width:200px;', '', 'form-control');
                        ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input type="text" class="solo_numeros input-group-addon form-control" name="valor_programa" id="valor_programa" placeholder="Valor Programa" value="<?php echo $valor_programa; ?>" onblur="trim_cadena(this); calcular_pago_neto();" />
                        </div>
                    </div>                    
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" name="descuento" id="descuento" placeholder="Descuento" value="<?php echo $descuento; ?>" onblur="trim_cadena(this); calcular_pago_neto();" />
                        </div>
                    </div>                    
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" name="valor_neto_pagar" id="valor_neto_pagar" disabled placeholder="Valor Neto" value="<?php echo $valor_neto_pagar; ?>" onblur="trim_cadena(this);" />
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <?php
                        $combo->getComboDb('id_forma_pago', $id_forma_pago, $dbListas->getListaDetallesEditabel(8), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                    </div>
                    
                    <div class="col-md-4 form-group">
                        <label for="">Entidad Financiera *</label>
                        <!-- <input type="text" class="form-control" name="entidad_financiera" id="entidad_financiera" placeholder="Entidad Financiera" value="<?php echo $entidad_financiera; ?>" onblur="trim_cadena(this); convertirAMayusculas(this);"> -->
                        <?php
                        $combo->getComboDb('id_entidad_financiera', $id_entidad_financiera, $dbListas->getListaDetallesEditabel(7), 'id_listas_editable_detalle, nombre_lista_editable_detalle', '--Seleccione--', '', '', '', '', 'form-control');
                        ?>
                    </div>                    
                        ...
                        foreach ($tabla_formas_pago as $fila_formas_pago) {
                            ...
                            if ($i == 1) {
                                ...
                                <div class="col-md-2 form-check-inline">
                                    ...
                                    <?php echo($nombre_forma);?>
                                        <input style="height: 20px;" type="checkbox" class="form-check-input form-control" name="check_forma_pago" id="check_forma_pago_<?php echo $id_forma_pago; ?>" value="<?php echo $id_forma_pago; ?>" <?php echo $checked; ?> onclick="mostrar_opciones(this);" > 
                                    </label>
                                </div>
                            ...
                            ?>
                            <script id="ajax">
                                var var_id_check = document.getElementById('check_forma_pago_'+ <?php echo($id_forma_pago); ?>);
                                //mostrar_opciones(var_id_check);
                            </script>
                            <?php
                ...
                <div id="div_credito_incad">
                <div class="row" >                    
                    <div class="col-md-3 form-group">
                        <label for="">Cuota Inicial *</label>
                        <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" name="cuota_inicial" id="cuota_inicial" placeholder="Cuota Inicial" value="<?php echo $cuota_inicial; ?>" onblur="trim_cadena(this); calcular_valor_financiar();" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" name="valor_financiar" id="valor_financiar" disabled placeholder="Valor a Financiar" value="<?php echo $valor_financiar; ?>" onblur="trim_cadena(this);" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <div class="input-group">
                        <span class="input-group-addon">#</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" name="num_cuotas" id="num_cuotas" placeholder="N&uacute;meros cuotas" value="<?php echo $num_cuotas; ?>" onblur="trim_cadena(this);" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-1 form-group">
                        ...
                        <div class="input-group">
                        <span class="input-group-addon">%</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" style="width: 50px;" name="valor_tasa" id="valor_tasa" placeholder="" value="" onblur="trim_cadena(this); calcular_valor_cuota();" />
                        </div>
                    </div>
                    
                    <div class="col-md-3 form-group">
                        <label for="">Periodicidad de pago *</label>
                        <?php
                        $combo->getComboDb('periodicidad_pago', $periodicidad_pago, $dbListas->getListaDetalles(12), 'id_detalle, nombre_detalle', '--Seleccione--', '', '', 'width:200px;', '', 'form-control');
                        ?>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 form-group">
                        ...
                        <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="solo_numeros input-group-addon form-control" name="valor_cuota" id="valor_cuota" placeholder="Valor cuotas" value="<?php echo $valor_cuota; ?>" onblur="trim_cadena(this);" />
                        </div>
                    </div>
                    
                    <div class="col-md-3 form-group">
                        <label for="">Fecha mensual de Pago*</label>
                        <input type="text" class="form-control" name="fecha_mensula_pago" id="fecha_mensula_pago" placeholder="Fecha Mensula Pago" value="<?php echo $fecha_mensula_pago; ?>" onblur="trim_cadena(this); convertirAMayusculas(this);">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        <label for="">¿Como se enter&oacute; de INCAD? *</label>                        
                    </div>                    
                        <?php
                        ...
                        foreach ($tabla_lista_conoce as $fila_lista_conoce) {
                            ...
                            if ($i == 1) {
                                ...
                                <div class="col-md-2 form-check-inline">
                                    ...
                                    <input style="height: 20px;" type="checkbox" class="form-check-input form-control" name="check_conoce_incad" id="check_conoce_incad_<?php echo $id_conoce; ?>" value="<?php echo $id_conoce; ?>" <?php echo $checked; ?> onclick="mostrar_opciones(this);" > 
                                    </label>
                                </div>
                            ...
                            ?>
                            <script id="ajax">
                                var var_id_check = document.getElementById('check_conoce_incad_'+ <?php echo($id_conoce); ?>);
                                mostrar_opciones(var_id_check);
                            </script>
                            <?php
                ...
                <div class="row">
                    <div id="div_referido_por" class="col-md-8 form-group">
                        <br />
                        <label for="">Referido por *</label>
                        <input type="text" class="form-control" name="referido_por" id="referido_por" placeholder="Referido Por" value="<?php echo $referido_por; ?>" onblur="trim_cadena(this); convertirAMayusculas(this);">
                    </div>                    
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        <br />
                        <label for="">Seleccione Promotor</label>
                        <?php
                        $combo->getComboDb('id_promotor', $id_promotor, $dbUsuariosPefiles->getUsuarios(2), 'id_usuario, nombre_completo', '--Seleccione--', '', '', 'width:200px;', '', 'form-control');
                        ?>
                    </div>
                    <div class="col-md-4 form-group">
                        <br />
                        <label for="">Estado de la Inscripci&oacute;n</label>
                        <?php
                        $combo->getComboDb('estado_matriculado', $estado_matriculado, $dbListas->getListaDetalles(14), 'id_detalle, nombre_detalle', '--Seleccione--', '', '', 'width:200px;', '', 'form-control');
                        ?>
                    </div>    
                            ...
                            <tr>    
                                ...
                                <div class="row" style="display: <?php echo($reg_visible);?>; ">
                                    ...
                                    <div class="col-md-2 form-group">
                                     ...
                                     <div class="col-md-2 form-group">
                                        <label for="">
                                            <a href="pdf_poligrafo.php?id_registro=<?php echo($id_academica);?>&id_credito=<?php echo($id_credito);?>" target="_blank"  >
                                            <img src="../imagenes/boton_imprimir_p.png" alt="Pagare Carta" height="42" width="42"><br />
                                            Polígrafo
                                            </a>
                                        </label>
    ...
    case "6": //
            ...
            $resultado = $dbRegistroPersonas->UpdateRegistroPersona($tipo_documento, $documento_persona, $lugar_documento, $fecha_documento, $nombre_persona, $apellido_persona, $fecha_nacimiento, $lugar_nacimiento, $tipo_sangre, $tel_casa_persona, $tel_movil_persona, $email_persona, $estado_civil, $direccion_casa, $barrio_residencia, $ciudad_residencia, $nombre_contacto_1, $telefono_contacto_1, $parentesco_contacto_1, $nombre_contacto_2, $telefono_contacto_2, $parentesco_contacto_2, $nombre_contacto_3, $telefono_contacto_3, $parentesco_contacto_3, $nombre_acudiente, $telefono_acudiente, $parentesco_acudiente, $eps, $tipo_inscripcion, $fecha_inscripcion, $id_ultimo_estudio, $institucion_estudio, $programa_incad, $jornada_incad, $valor_programa, $descuento, $valor_neto_pagar, $id_forma_pago, $id_entidad_financiera, $cuota_inicial, $valor_financiar, $num_cuotas, $valor_cuota, $fecha_mensula_pago, $array_conoce_incad, $referido_por, $estrato_persona, $programa_tecnico, $practica_laboral, $sexo, $unidad_negocio, $calendario_academico, $jornada, $id_programa, $periodicidad_pago, $id_promotor, $estado_matriculado, $id_usuario_crea, $hdd_id_persona, $hdd_id_academica);
    ...
    case "14": // Listado de Personas encontradas
        
        
        $txt_busca_id = $_POST["txt_busca_id"];		
        //$tabla_registro = $dbRegistroPersonas->getPersona($txt_busca_id);
        $tabla_listado_registro = $dbRegistroPersonas->getBuscarPersona($txt_busca_id);
        $cantidad_registro = count($tabla_listado_registro);
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" >
                        <thead>
                            <tr><th colspan='8' style="text-align: center;">Datos Personales</th></tr>
                            <tr>
                                <th style="width:5%;text-align:center;">Documento</th>
                                <th style="width:15%;text-align:center;">Nombre Completo</th>
                                <th style="width:10%;text-align:center;">Telefonos</th>
                                ...
                                <th style="width:20%;text-align:center;">Direcci&oacute;n</th>
                                <th style="width:10%;text-align:center;">Ciudad</th>
                                <th style="width:10%;text-align:center;">Cargar Estudiante</th>
                                <th style="width:10%;text-align:center;">Firmar Documentos</th>
                            </tr>
                        </thead>
                        <?php
                        if ($cantidad_registro > 0) {
                            foreach ($tabla_listado_registro as $tabla_registro){                                
                                
                                $i = 1;


                                @$id_persona = $tabla_registro['id_persona'];
                                @$nombre_completo = $tabla_registro['nombre_completo'];
                                @$documento_persona = $tabla_registro['documento_persona'];
                                @$fecha_nacimiento = $tabla_registro['format_fecha_nacimiento'];                                
                                @$tel_casa_persona = $tabla_registro['tel_casa_persona'];
                                @$tel_movil_persona = $tabla_registro['tel_movil_persona'];
                                ...
                                <tr>    
                                    ...
                                    <td align="left"><?php echo $ciudad_residencia; ?></td>                                    
                                    <td align="left">                                        
                                        <button type="button" id="btn_crear_usuario" class="btn btn-default" onclick="cargar_registro_id(<?php echo $documento_persona; ?>);">Cargar</button>
                                    </td>
                                    <td align="left">                                        
                                        <button type="button" id="btn_crear_usuario" class="btn btn-default" onclick="cargar_firmar_documentos(<?php echo $documento_persona; ?>);">Ver Documentos</button>
                                    </td>
                                </tr>
                                <?php
                            ...
                            ?>
                            <tr>
                                <td align="center" colspan="7">No se encontraron datos<br />Desea crea un nuevo registro ? </td>
                            </tr>
                            <tr>
                                <td align="center" colspan="7">
                                	<button type="button" id="btn_crear_usuario" class="btn btn-success" onclick="llamar_crear_registro('<?php echo($txt_busca_id);?>');">Nuevo Registro</button>
