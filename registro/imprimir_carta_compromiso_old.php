...
<page backimg="../imagenes/Fondo_carta.png">
    ...
    <table border='0' style="margin-left:30px; margin-top:200px;">        
        <tr>            
            <td width="50">&nbsp;</td>
            <td width="630">
    ...
    <table border='0' style="margin-left:30px; margin-top:70px;">        
        ...
        <tr>            
            <td width="50">&nbsp;</td>
            <td width="630">
            <p class="parrafo_text_1"><b>INCAD</b></p>    
            </td>
        </tr>               
        <tr>            
            <td width="50">&nbsp;</td>
    ...
    <table border='0' style="margin-left:30px; margin-top:60px;">        
        <tr>            
            <td width="50">&nbsp;</td>
            <td width="630">
            <p class="parrafo_text_1">Yo <b><?php echo($nombre_firma);?></b> con  cedula No. <b><?php echo($documento_firma);?></b> de <b><?php echo($lugar_documento);?></b>; me  comprometo  a entregar los documentos  de codeudor   para   la    legalización  de  mi  matricula    en   un    plazo no mayor de un mes, documentos pendientes:</p>    
            </td>
        </tr>
        <tr>            
            <td width="50">&nbsp;</td>
            <td width="630">
            <p class="parrafo_text_1" style="margin-top:10px;">____________________________________________________________________________</p>    
            </td>
        </tr>
        <tr>            
            <td width="50">&nbsp;</td>
    ...
    <table border='0' style="margin-left:30px; margin-top:50px;">        
        <tr>            
            <td width="50">&nbsp;</td>
            <td width="630">
            <p class="parrafo_text_1">Se firma el día ______ del   mes _________ del  año______.</p>    
            </td>
        </tr>               
    </table>
    ...
    <br />   
     <table class="tabla_info" border='0' style="margin-left:45px; margin-top:150px;">        
        <tr>
            <td width="10">&nbsp;</td>
            <td style="padding: 20px 0 0 0;"><b>Firma:</b> </td>
            <td style="padding: 20px 0 0 0;"><p>_________________________________________</p></td>
        </tr> 
         <tr >
            <td width="10">&nbsp;</td>
            <td style="padding: 20px 0 0 0;"><b>Atentamente: </b></td>
            <td style="padding: 20px 0 0 0;" width="250"><b><?php echo($nombre_firma);?> </b> </td>
        </tr>        
	    <tr>
            <td width="10">&nbsp;</td>
            <td style="padding: 20px 0 0 0;"><b>Identificación: </b> </td>
            <td style="padding: 20px 0 0 0;" width="250"><b><?php echo($documento_firma);?></b> </td>
        </tr> 
