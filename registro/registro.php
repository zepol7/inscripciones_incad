...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <script>
        async function obtenerPDFBase64(id_registro, tipo) {
        // Llamada al php que devuelve el base64
        const response = await fetch(`pdf.php?id_registro=${id_registro}&tipo=${tipo}`);
        const data = await response.json(); // Asumiendo que pdf.php devuelve JSON con "base64"

        // Guardar el base64 en una variable
        let pdfBase64 = data.base64;

        console.log("Base64 recibido:", pdfBase64.substring(0, 100) + "..."); // mostrar los primeros 100 chars
        return pdfBase64;
        }

        // Ejecutar automáticamente al cargar la página
        window.onload = async () => {
        const id = "<?php echo $id_academica; ?>"; // valor desde PHP
        const base64 = await obtenerPDFBase64(id, 1);

        // Aquí ya tienes el base64 en una variable JS
        // Ejemplo: forzar descarga del PDF
        const link = document.createElement('a');
        link.href = "data:application/pdf;base64," + base64;
        link.download = `archivo_${id}.pdf`;
        link.click();
        };
    </script>
    ...
    <body>    	
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                'SOAPAction: "http://tempuri.org/ObtenerRt"'
            ),
            ));
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <ol class="breadcrumb">
                        ...
                        <li>Inscripci&oacute;n de Estudiantes </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
            	...
            	<div class="col-md-12">
                        <div id="principal_registro_create_edit"></div>
        ...
        <script type='text/javascript' src='registro_v1.19.js'></script>
