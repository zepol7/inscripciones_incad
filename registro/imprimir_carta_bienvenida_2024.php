    ...
    ?>   
        <table border='0' style="margin-left:30px; margin-top:30px;">        
            <tr>            
                <td width="50">&nbsp;</td>
                <td width="630">
                <p class="parrafo_text_1">El INSTITUTO INCAD SAS, institución de educación para el trabajo y el desarrollo humano, le da la bienvenida y le ofrece un cordial y especial saludo de paz y bien.</p>    
                </td>
            </tr>        
        </table>    
        <table border='0' style="margin-left:30px; margin-top:30px;">        
            <tr>            
                <td width="50">&nbsp;</td>
                <td width="630">
                <p class="parrafo_text_1">Queremos comunicarle que estamos comprometidos en su proceso de aprendizaje, por lo cual a partir de ahora, tiene a disposición nuestra infraestructura y todos sus recursos, así como nuestro personal idoneo y capacitado para que pueda llevar a feliz término su programa académico matriculado.</p>    
                </td>
            </tr>        
        </table>    
        <table border='0' style="margin-left:30px; margin-top:30px;">        
            <tr>            
                <td width="50">&nbsp;</td>
                <td width="630">
                <p class="parrafo_text_1">Igualmente recordarle que al firmar nuestro contrato de suministro de servicio educativo, en la clausula 8, claramente dejamos consignado que no hacemos devoluciones de dinero, en ningun caso, a pesar de no continuar por algunas circunstancia sus estudios. Por lo tanto si tuviese algun motivo de fuerza mayor que le impida continuar, usted podra academicamente aplazar o ceder su programa; sin embargo si tiene un crédito educativo pendientes con INCAD, tiene la obligación financiera de cumplir con los pagos puntuales de las cuotas, de no ser así, la institución procederá de acuerdo a las políticas de cartera establecidas, para hacer efectivo el pago de las cuotas atrazadas o en su defecto el valor total del crédito pendiente.</p>    
                </td>
            </tr>        
        </table> 
        <table border='0' style="margin-left:30px; margin-top:30px;">        
            <tr>            
                <td width="50">&nbsp;</td>
                <td width="630">
                <p class="parrafo_text_1">Esperamos que su presencia como estudiante de nuestra institución sea grata, productiva y con nuestro decidido apoyo pueda tener total éxito en lograr esta meta de estudiar, aprender y trabajar.</p>    
                </td>
            </tr>        
        </table>        
